...
cd $CURRENT_DIR/$DIR
#共存
sed -i 's/com.github.fongmi.android.tv/com.github.fongmi.android.tv.kk/g' $CURRENT_DIR/$DIR/app/build.gradle
sed -i 's/0.0.1/0.0.2/g' $CURRENT_DIR/$DIR/app/build.gradle
#签名
...
#名称修改
sed -i 's/影视/五彩田园/g' $CURRENT_DIR/$DIR/app/src/main/res/values-zh-rCN/strings.html
#图标修改
